<div class="idea-and-buttons container">
    ...
    <div
        class="idea-container bg-white dark:bg-gray-800 rounded-xl flex mt-4 hover:shadow-card transition duration-150 ease-in border border-gray-200 dark:border-gray-700">
        <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
            <div class="flex-none mx-2 md:mx-4">
                <a href="#">
                    <img src="{{ $idea->user->profile_photo_url }}" alt="avatar" class="w-14 h-14 rounded-xl">
                </a>
            </div>
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    <div class="flex items-center text-xs text-gray-400 dark:text-white font-semibold space-x-2">
                        <div class="hidden md:block font-bold text-gray-900 dark:text-white">{{ $idea->user->name }}
                        </div>
                    ...
                    <div class="flex items-center space-x-2 mt-4 md:mt-0" x-data="{ isOpen: false }">
                        ...
                        <div class="relative">
                            ...
                            <ul class="absolute w-44 text-left font-semibold bg-white shadow-dialog rounded-xl z-10 py-3 top-8 md:top-6"
                                ...
                                <li>
                                    ...
                                    {{-- <button type="button" data-modal-target="delete-popup-modal"
                                        data-modal-toggle="delete-popup-modal"
                                        class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">
                                        Delete
                                    </button> --}}
                                </li>
        ...
        <div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">
            <div x-data="{ isOpen: false }" class="relative">
                <button type="button" @click="isOpen = !isOpen"
                    class="flex items-center justify-center h-11 w-32 text-sm bg-blue-700 text-white font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">
                    Reply
                </button>
