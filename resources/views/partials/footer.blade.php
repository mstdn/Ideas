<footer
    class="bg-white rounded-lg sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 mt-12 border border-gray-200 dark:border-gray-700">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2023. <a href="/" class="hover:underline" target="_blank">{{ config('app.name', 'Meows') }}</a>.
    </p>
