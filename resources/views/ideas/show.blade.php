<x-app-layout>
    ...
    <div class="idea-container bg-gray-50 dark:bg-gray-800 dark:border-gray-900 border border-gray-200 rounded-xl flex mt-4">
        <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
            <div class="flex-none mx-2 md:mx-4">
                <a href="#">
                    <img src="{{ $idea->user->profile_photo_url }}" alt="{{ $idea->user->name }}" class="w-14 h-14 rounded-xl">
                </a>
            </div>
