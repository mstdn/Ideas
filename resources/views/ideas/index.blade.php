    ...
    <div class="ideas-container space-y-6 my-8">
        ...
        <div x-data @click="
            ...
            <div class="hidden md:block border-r border-gray-200 dark:border-gray-700 px-5 py-8">
                ...
                <div class="mt-8">
                    <button
                        class="w-20 bg-gray-200 dark:border-gray-900 border border-gray-200 font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3">Vote</button>
                </div>
            </div>
                ...
                <div class="w-full flex flex-col justify-between mx-2 md:mx-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div x-data="{ isOpen: false }" class="flex items-center space-x-2 mt-4 md:mt-0">
                            ...
                            <div
                                class="{{ $idea->status->classes }} text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4 text-gray-900 dark:text-white">
